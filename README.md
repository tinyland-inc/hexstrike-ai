...
Auditable, provable cybersecurity MCP platform. 42 tools across 13 domains, with verified dispatch, hash-chain audit, and grants-as-capabilities policy enforcement.
